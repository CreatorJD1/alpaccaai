...
if not defined ALPECCA_ROG_WORKER_URL set "ALPECCA_ROG_WORKER_URL=https://Jason_HOLYROG:8788"
if not defined ALPECCA_ROG_WORKER_CA_CERT set "ALPECCA_ROG_WORKER_CA_CERT=%LOCALAPPDATA%\Alpecca\rog-worker\tls\jason-holyrog.crt"
if not defined ALPECCA_ROG_WORKER_MODEL set "ALPECCA_ROG_WORKER_MODEL=qwen3.5:9b"
if not defined ALPECCA_DEEP_BACKEND set "ALPECCA_DEEP_BACKEND=rog-worker,ollama-cloud"
