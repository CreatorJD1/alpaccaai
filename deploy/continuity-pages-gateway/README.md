...
`pages.dev` route to the existing continuity authority, encrypted Vault, and
the stateless text-only language Worker.
...
- `/language/*` forwards to `alpecca-cloud-language`.
...
Deploy from this directory after the three bound Workers exist:
