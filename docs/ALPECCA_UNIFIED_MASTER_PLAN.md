...
| **E2 — Discord voice** | Join VC, speak TTS, creator-only Sink -> local Whisper -> signed guest turn -> spoken reply | P10 voice (**IMPLEMENTED BASELINE; LIVE SOAK PENDING**) | Claimed-room, creator allowlist, 12-second RAM cap, content-free audit, bounded queue | Codex P10 + Experience |
