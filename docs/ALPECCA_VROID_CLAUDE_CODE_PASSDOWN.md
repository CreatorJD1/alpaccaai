...
- Hair clip: VRoid 2.14 has NO hairpin/ribbon accessory preset (only Glasses/Furry Ears/Tail/Hat) and no clip `.vroidcustomitem` exists in the repo. Needs a BOOTH hairpin custom item or a manual freehand hair-strand clip.
