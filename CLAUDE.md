...
- The VRM/VRoid companion path is experimental and must not replace the 2D/House HQ pipeline unless Jason explicitly approves.
...
2. Check `HANDOFF.md`.
3. Inspect the relevant files instead of assuming old duplicated context is current.
